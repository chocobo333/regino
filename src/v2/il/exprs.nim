...
proc Literal*(_: typedesc[Expression], val: Literal, loc: Location = newLocation()): Expression =
    Expression(kind: ExpressionKind.Literal, val: val, loc: loc)
...
proc Record*(_: typedesc[Expression], members: Table[string, Expression], loc: Location = newLocation()): Expression =
    Expression(kind: ExpressionKind.Record, members: members, loc: loc)
proc If*(_: typedesc[Expression], elifs: seq[ElifBranch], elseb: ElseBranch, loc: Location = newLocation()): Expression =
...
proc Apply*(_: typedesc[Expression], callee: Expression, args: seq[Expression], loc: Location = newLocation()): Expression =
...
proc Bracket*(_: typedesc[Expression], callee: Expression, args: seq[Expression], loc: Location = newLocation()): Expression =
